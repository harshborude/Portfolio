    ...
    <footer className="w-full border-t border-white/10 mt-20 py-8">
      <div className="max-w-6xl mx-auto px-5 flex flex-col items-center gap-4">
        ...
        <div className="flex gap-6">
          ...
          >
            <img src="/images/github.webp" alt="GitHub" className="size-6 opacity-70 hover:opacity-100" />
          ...
          <a
            ...
            className="text-white/70 hover:text-white transition"
          >
            <img src="/images/linkedin.png" alt="LinkedIn" className="size-6 opacity-70 hover:opacity-100" />
          ...
          <a
            ...
            className="text-white/70 hover:text-white transition"
          >
            <img src="/images/x.png" alt="X (Twitter)" className="size-6 opacity-70 hover:opacity-100" />
          </a>
        </div>
